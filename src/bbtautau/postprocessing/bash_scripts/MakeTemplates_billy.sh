...
MAIN_DIR="/home/users/haoyang/bbtautau_ggfvbf"
...
SENSITIVITY_DIR="/home/users/lumori/bbtautau/plots/SensitivityStudy/2025-12-27/" #"${MAIN_DIR}/plots/SensitivityStudy/2025-12-12/" is bmin = 10, "${MAIN_DIR}/plots/SensitivityStudy/2025-12-15/" is bmin = 5
TAG=""
USE_PART=0
DO_VBF=1
